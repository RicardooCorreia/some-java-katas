package update_needed.kangaroo;
...
public class Solution {
    ...
    // Complete the update_needed.kangaroo function below.
    static String kangaroo(int k1StartPosition, int k1JumpSize, int k2StartPosition, int k2JumpSize) {
        // Kangaroo 2 always start ahead of 1, so if the the jump size of the update_needed.kangaroo 2 is bigger than the update_needed.kangaroo 1
        // then update_needed.kangaroo 1 never going to catch him.
